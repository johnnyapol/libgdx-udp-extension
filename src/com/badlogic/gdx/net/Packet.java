...
/**
 * Packet - A basic class allowing for a simpler transmission of data than using
 * raw datagrams
 * 
 * @author Unkn0wn0ne
 */
public class Packet implements Disposable{
	 ...
	 * @param port
	 *            The port to send the datagram to
	...
	/**
	 * Converts the datagram into a packet for use of the read methods in this
	 * class
	 * 
	 * @param d
	 ...
	 * 
	 * @return A string from the received datagram, or null if no datagram has
	 *         been converted using {@link Packet#readDatagram(Datagram)}
	 * @throws IOException
	 *             If there was any error reading the data
	 */
	 ...
	 * 
	 * @param str
	 *            The string to write, or null if no datagram has been converted
	 *            using {@link Packet#readDatagram(Datagram)}
	 * @throws IOException
	 *             If there was an error writing the string
	 */
	 ...
	 * 
	 * @return An integer from the datagram, or null if no datagram has been
	 *         converted using {@link Packet#readDatagram(Datagram)}
	 * @throws IOException
	 *             If there was an error reading the integer
	 */
	 ...
	 * @throws IOException
	 *             If there was an error writing the integer
	 */
	 ...
	 * 
	 * @return A double from the received datagram, or null if no datagram has
	 *         been converted using {@link Packet#readDatagram(Datagram)}
	 * @throws IOException
	 *             If there was an error reading the double
	 */
	 ...
	 * @throws IOException
	 *             If there was an error writing the double
	 */
	 ...
	 * 
	 * @return A float from the received datagram, or null if no datagram has
	 *         been converted using {@link Packet#readDatagram(Datagram)}
	 * @throws IOException
	 *             If there was an error reading the float
	 */
	 ...
	 * @throws IOException
	 *             If there was an error writing the float
	 */
	 ...
	 * 
	 * @return A boolean from the received datagram, or null if no datagram has
	 *         been converted using {@link Packet#readDatagram(Datagram)}
	 * @throws IOException
	 *             If there was an error reading the boolean
	 */
	 ...
	 * @throws IOException
	 *             If there was an error writing the boolean
	 */
	 ...
	 * @throws IOException
	 *             If the stream was not created yet, or if there was another
	 *             error reading the short
	 */
	public Short readShort() throws IOException {
		if (this.dis == null)
			throw new IOException(
					"Stream not created. Did you not call Packet.receiveDatagram ?");
	 ...
	 * @throws IOException
	 *             If there was an error writing the short
	 */
	 ...
	 * @throws IOException
	 *             If there was an error reading the byte array
	 */
	 ...
	 * @throws IOException
	 *             If there was an error writing the byte array
	 */
	 ...
	 * 
	 * @throws IOException
	 *             If there was an error flushing the streams
	 */
