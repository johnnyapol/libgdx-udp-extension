...
* We try to provide you with a low-latency, but reliable connection.
* @author Unkn0wn0ne
*/
public class UDPSocketHints {
        ...
        /**
         * Enables SO_BROADCAST for the DatagramSocket. You may need special permissions to use this on certain operating systems or alternate virtual machines
         * Default: false
         */
        public boolean SO_BROADCAST = false;
        
        /**
         * Enables the SO_REUSEADDR for the DatagramSocket. This is not supported on all platforms.
         * Default: false
         */
